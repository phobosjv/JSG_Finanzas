...
SECTIONS = [
    ...
    ("Novedades en v1.4.3", [
        ...
        "    catalogo-valores.json incluido en el paquete de instalacion) y anade",
    ...
    ("Novedades en v1.4.1 - Correcciones", [
        ...
        "     sin error, pero al cargar la cartera devolvia error 500. Ahora el",
    ...
    ("Novedades en v1.3.0", [
        ...
        "    Al deshabilitar se puede anadir una anotacion (motivo).",
